...
def main(folder_path, max_columns, name_replace, CSV_path):
    ...
    for file_path in file_paths[:]:
        with open(file_path, 'r') as f:
            ...
            if len(file_tolist) < (max_columns + 4):
            ...
            for i in range(max_columns):
                ...
                for word4 in file_tolist[i+3]:
                    square4 += ord(word4) ** 2
                vector4 = square4 / len(file_tolist[i+3])
...
if __name__ == '__main__':
    ...
    CSV_path = './CSV/Binarization/ascii/ascii_' + str(max_columns) + 'four.csv'
