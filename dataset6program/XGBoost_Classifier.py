...
def main():
    ...
    # saving_file_path = f"../experiment/dataset6/XGBoost/Log{LogBoolean}/{vectorizer_name}/{n_gram}/report.txt"
    # saving_plot_path   = f"../experiment/dataset6/XGBoost/Log{LogBoolean}/{vectorizer_name}/{n_gram}/importances.png"
    ...
    # saving_file_path = f"../experiment/dataset6/XGBoost/Log{LogBoolean}/{vectorizer_name}/{bucket_len}/{n_gram}/report.txt"
    # saving_plot_path   = f"../experiment/dataset6/XGBoost/Log{LogBoolean}/{vectorizer_name}/{bucket_len}/{n_gram}/importances.png"
    # target_csv = f"../CSV/dataset6CSV/{vectorizer_name}/{n_gram}_PositionBucket_{bucket_len}_Log{LogBoolean}.csv"

    """Doc2Vec"""
    # saving_file_path = f"../experiment/dataset6/XGBoost/doc2vec/report.txt"
    # saving_plot_path = f"../experiment/dataset6/XGBoost/doc2vec/importances.png"
    # target_csv = "../CSV/dataset6CSV/doc2vec/2label.csv"

    """TFIDF"""
    n_gram = "3gram"

    saving_file_path = f"../experiment/dataset6/XGBoost/tfidf/{n_gram}/report.txt"
    saving_plot_path = f"../experiment/dataset6/XGBoost/tfidf/{n_gram}/importances.png"
