...
def main():
    targetcsv_path = "../../CSV/dataset7CSV/origin/2label.csv"
    saveing_path = "../../CSV/dataset7CSV/doc2vec/2label.csv"
    ...
    """ファイルに実行時間を保存"""
    savign_file_path = f"../../experiment/dataset7/vectorizer_time/doc2vec/time.txt"
