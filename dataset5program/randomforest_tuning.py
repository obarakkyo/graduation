...
if __name__ == "__main__":
    target_csv = "../CSV/dataset5CSV/bucket/Position_64_2label.csv"
    # target_csv = "../CSV/dataset5CSV/bucket/Position_128_2label.csv"

    # target_csv = "../CSV/dataset5CSV/ascii/2label.csv"
