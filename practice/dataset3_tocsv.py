...
def create_index_name(file_path):
    indexname = file_path.replace("../custom_datasets/dataset_3\\", "")
...
def main():
    # 対象フォルダの指定 #
    target_folder_path = "../custom_datasets/dataset_3/*json"
...
if __name__ == "__main__":
    print("-----This program changes dataset3 to CSV!!-----")
    main()