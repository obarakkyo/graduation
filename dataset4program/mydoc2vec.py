...
def main():
    """初期値変数"""
    # targetcsv_path = "../CSV/dataset4CSV/origin/6label.csv"
    # saveing_path = "../CSV/dataset4CSV/doc2vec/6label.csv"

    targetcsv_path = "../CSV/dataset4CSV/origin/6label_WithoutSummary.csv"
    saveing_path = "../CSV/dataset4CSV/doc2vec/6labelWithoutSummary.csv"
...
if __name__ == "__main__":
    print("このプログラムはdataset4に特化したDocVecです。")
    main()