"""
RandomDataProject用のXGBoostプログラム．
...
def XGBoostMain(status_dict=None):
    """
    メイン関数
    """
    # データの取得 #
...
if __name__ == "__main__":
    ...
    for path in csvpaths[:]:
        ...
        status_dict = {
            "vectorizer" : "ascii",
            "targetCSV" : path,
            "SavingPath" : f"experiment/RandomDataProject/MachineLearning/XGBoost/ascii/{filename}.txt",
            "SavingPlotPath" : f"experiment/RandomDataProject/MachineLearning/XGBoost/ascii/{filename}.png"
        }
        XGBoostMain(status_dict)
    ...
    for path in csvpaths[:]:
        ...
        status_dict = {
            "vectorizer" : "bucket",
            "targetCSV" : path,
            "SavingPath" : f"experiment/RandomDataProject/MachineLearning/XGBoost/bucket/[64]{filename}.txt",
            "SavingPlotPath" : f"experiment/RandomDataProject/MachineLearning/XGBoost/bucket/[64]{filename}.png"
        }
        XGBoostMain(status_dict)
    ...
    for path in csvpaths[:]:
        ...
        status_dict = {
            "vectorizer" : "bucket",
            "targetCSV" : path,
            "SavingPath" : f"experiment/RandomDataProject/MachineLearning/XGBoost/bucket/[128]{filename}.txt",
            "SavingPlotPath" : f"experiment/RandomDataProject/MachineLearning/XGBoost/bucket/[128]{filename}.png"
        }
        XGBoostMain(status_dict)
    ...
    for path in csvpaths[:]:
        ...
        status_dict = {
            "vectorizer" : "tfidf",
            "targetCSV" : path,
            "SavingPath" : f"experiment/RandomDataProject/MachineLearning/XGBoost/tfidf/{filename}.txt",
            "SavingPlotPath" : f"experiment/RandomDataProject/MachineLearning/XGBoost/tfidf/{filename}.png"
        }
        XGBoostMain(status_dict)